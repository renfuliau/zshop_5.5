                            ...
                            <div class="product-buy">
                                ...
                                <div class="mt-4">
                                    ...
                                    <a class="btn cart add-to-cart text-white" @if (!empty(Auth::user()->id))
                                        ...
                                        @endif
                                        data-product_id="{{ $product_detail->id }}">{{ __('frontend.add-to-cart') }}</a>
                                ...
                                {{-- </form> --}}
                                <p class="availability">{{ __('frontend.product-stock') }} : @if ($product_detail->stock > 0)<span
                        ...
                        <div class="product-info">
                            <div class="nav-main">
                                ...
                                <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <h4>{{ __('frontend.product-detail') }}</h3>
                                    </li>
                                </ul>
                                <!--/ End Tab Nav -->
                            </div>
